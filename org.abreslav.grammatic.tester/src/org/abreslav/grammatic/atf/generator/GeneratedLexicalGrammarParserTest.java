...
import org.abreslav.grammatic.grammar1.GrammaticLexicalGrammarLexer;
import org.abreslav.grammatic.grammar1.GrammaticLexicalGrammarParser;
...
public class GeneratedLexicalGrammarParserTest {
	...
	private TemplateBody<? extends Expression> parseString(String data)
		...
		GrammaticLexicalGrammarLexer tokenSource = new GrammaticLexicalGrammarLexer(input);
		GrammaticLexicalGrammarParser parser = new GrammaticLexicalGrammarParser(new CommonTokenStream(tokenSource));
		parser.setModuleImplementations(new GrammaticCharacterModuleImplementationProvider(), 
				new GrammaticLexicalGrammarModuleImplementationProvider(), new StringModule());
